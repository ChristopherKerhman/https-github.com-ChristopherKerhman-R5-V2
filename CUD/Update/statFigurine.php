...
if($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  `nomFigurine`= :nomFigurine,`description`=:description,`typeFigurine`=:typeFigurine,`tailleFigurine`=:tailleFigurine,`DQM`=:DQM,`DC`=:DC,`pdv`=:pdv, `svg`=:svg,`mouvement`=:mouvement WHERE `idFigurine` = :idFigurine";
  print_r($prepare);
